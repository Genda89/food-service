...
import { INVALID, PATHS } from '../../../constants';
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    try {
      ...
      if (!emailError && !passwordError) {
        ...
        const user = await fetchData({ url: PATHS.AUTH_LOGIN, method: 'post', data });
    ...
    <>
      ...
      <Container
        ...
        <Box
          ...
          <Link component={ReactRouterLink} to={`/${PATHS.REGISTER}`} sx={{ margin: '0 auto' }}>
